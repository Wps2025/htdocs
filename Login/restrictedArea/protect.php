...
if (!isset($_SESSION['user_id'])) {
    ...
    echo "<br><a>Não tem uma conta? </a><a href='/projeto-candidatos/structure/formulario'>Cadastre-se</a>";
    echo "<a> ou </a><a href='/projeto-candidatos/structure/login'>Login</a>";
    exit();
